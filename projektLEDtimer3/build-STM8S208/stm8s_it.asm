...
; genEndFunction
	iret
;	./src/stm8s_it.c: 275: INTERRUPT_HANDLER(TIM2_UPD_OVF_BRK_IRQHandler, 13)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 303: INTERRUPT_HANDLER(TIM3_UPD_OVF_BRK_IRQHandler, 15)
; genLabel
;	-----------------------------------------
...
;	Reset bit 6 of reg CC. Hardware bug workaround.
	div	x, a
;	./src/stm8s_it.c: 305: TIM3_ClearFlag(TIM3_FLAG_UPDATE);
; genSend
	clrw	x
	incw	x
; genCall
	call	_TIM3_ClearFlag
;	./src/stm8s_it.c: 307: if (ledpointer == 0) {
; genIfx
	tnz	_ledpointer+0
	jreq	00130$
	jp	00102$
00130$:
;	./src/stm8s_it.c: 308: REVERSE(DB_LED1);
; genSend
	ld	a, #0x01
; genSend
	ldw	x, #0x501e
...
;	./src/stm8s_it.c: 309: LOW(DB_LED6);
; genSend
	ld	a, #0x20
; genSend
	ldw	x, #0x501e
; genCall
	call	_GPIO_WriteLow
;	./src/stm8s_it.c: 310: LOW(DB_LED8);
; genSend
	ld	a, #0x80
; genSend
	ldw	x, #0x501e
...
; genLabel
00102$:
;	./src/stm8s_it.c: 312: if (ledpointer == 1){
; genCmpEQorNE
	ld	a, _ledpointer+0
	dec	a
	jrne	00132$
...
;	./src/stm8s_it.c: 313: REVERSE(DB_LED6);
; genSend
	ld	a, #0x20
; genSend
	ldw	x, #0x501e
; genCall
	call	_GPIO_WriteReverse
;	./src/stm8s_it.c: 314: LOW(DB_LED8);
; genSend
	ld	a, #0x80
; genSend
	ldw	x, #0x501e
; genCall
	call	_GPIO_WriteLow
;	./src/stm8s_it.c: 315: LOW(DB_LED1);
; genSend
	ld	a, #0x01
; genSend
	ldw	x, #0x501e
...
; genLabel
00104$:
;	./src/stm8s_it.c: 317: if (ledpointer == 2){
; genCmpEQorNE
	ld	a, _ledpointer+0
	cp	a, #0x02
	jrne	00135$
...
00136$:
; skipping generated iCode
;	./src/stm8s_it.c: 318: REVERSE(DB_LED8);
; genSend
	ld	a, #0x80
; genSend
	ldw	x, #0x501e
; genCall
	call	_GPIO_WriteReverse
;	./src/stm8s_it.c: 319: LOW(DB_LED1);
; genSend
	ld	a, #0x01
; genSend
	ldw	x, #0x501e
; genCall
	call	_GPIO_WriteLow
;	./src/stm8s_it.c: 320: LOW(DB_LED6);
; genSend
	ld	a, #0x20
; genSend
	ldw	x, #0x501e
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 329: INTERRUPT_HANDLER(TIM3_CAP_COM_IRQHandler, 16)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 346: INTERRUPT_HANDLER(UART1_TX_IRQHandler, 17)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 358: INTERRUPT_HANDLER(UART1_RX_IRQHandler, 18)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 371: INTERRUPT_HANDLER(I2C_IRQHandler, 19)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 411: INTERRUPT_HANDLER(UART3_TX_IRQHandler, 20)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 423: INTERRUPT_HANDLER(UART3_RX_IRQHandler, 21)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 438: INTERRUPT_HANDLER(ADC2_IRQHandler, 22)
; genLabel
;	-----------------------------------------
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 494: INTERRUPT_HANDLER(TIM4_UPD_OVF_IRQHandler, 23)
; genLabel
;	-----------------------------------------
...
;	Reset bit 6 of reg CC. Hardware bug workaround.
	div	x, a
;	./src/stm8s_it.c: 496: TIM4_ClearFlag(TIM4_FLAG_UPDATE);
; genSend
	ld	a, #0x01
; genCall
	call	_TIM4_ClearFlag
;	./src/stm8s_it.c: 497: miliseconds++;
; genAssign
...
; genEndFunction
	iret
;	./src/stm8s_it.c: 506: INTERRUPT_HANDLER(EEPROM_EEC_IRQHandler, 24)
; genLabel
;	-----------------------------------------
